        ...
        <Box sx={{ p: 4, bgcolor: '#f8fafc', minHeight: '100vh' }}>
            ...
            <Box sx={{ mb: 4 }}>
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mt: 0.5 }}>
                    ...
                    <Box sx={{ color: '#94a3b8', display: 'flex' }}><FaChevronRight size={10} /></Box>
                    <Typography variant="body2" color="#1e293b" fontWeight={600}>Attendance Summary</Typography>
                </Box>
            </Box>
                    ...
                    <Grid item xs={12} lg={5}>
                        <Box sx={{ display: 'flex', gap: 2, justifyContent: 'flex-end' }}>
                            <FormControl size="small" sx={{ minWidth: 150 }}>
                                ...
                                <Select value="" label="Select User..." onChange={(e) => setSearchTerm(e.target.value)} sx={{ borderRadius: '12px' }}>
                                    <MenuItem value="">All Users</MenuItem>
                                    {data.map(emp => <MenuItem key={emp.id} value={emp.name}>{emp.name}</MenuItem>)}
                                </Select>
                            </FormControl>
